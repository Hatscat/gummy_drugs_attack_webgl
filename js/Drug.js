var Drug = function(config, x, z, name) {
	this.config = config;
	...
	this.mesh.material = config.DrugManager.drugsMaterials[(Math.random() * config.DrugManager.drugsMaterialsNb | 0)];
}

Drug.prototype.update = function(deltaTime) {
