...
DrugManager.prototype.createMaterials = function() {
...
DrugManager.prototype.spawnDrug = function(x,z) {
	var name = "drug" + this.drugsNameCount;
	this.drugs[name] = new Drug(this.config, x, z, name);
	this.drugsNameCount++;
}

DrugManager.prototype.updateDrugs = function(deltaTime) {
...
DrugManager.prototype.deleteDrug = function(name) {
